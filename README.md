# Эффективный выбор карт из данных Simurg

Примеры [карт](https://simurg.iszf.irk.ru/events?event=storms). Данные [здесь](https://simurg.iszf.irk.ru/db) выбирать с полным набором станций, например 26.08.2018. 
